...
**Última atualização do site**: `r data <- function(){
...
Utilizando o ícone de lupa, na barra superior desse site, o condômino poderá buscar por palavras chaves. Isso poderá ajudar à obter informações mais rapidamente.
```
